...
{
    /// <summary>
    /// Renders a D8 die with textured number faces.
    /// Click to roll the die with animation.
    /// </summary>
    public class D8TestRenderer : IDisposable
    {
        private readonly GraphicsDevice _graphicsDevice;
        private readonly BasicEffect _effect;
        private readonly Texture2D _dieTexture;
        private D8Generator.D8Mesh _mesh;
        ...
        /// </summary>
        public int CurrentResult { get; private set; } = 8;
        ...
        public D8TestRenderer(GraphicsDevice graphicsDevice, SpriteFont font)
        {
            _graphicsDevice = graphicsDevice ?? throw new ArgumentNullException(nameof(graphicsDevice));
            _previousMouseState = Mouse.GetState();

            // Generate D8 texture atlas
            Color dieColor = new Color(30, 100, 180);    // Blue
            Color numberColor = new Color(255, 215, 0); // Gold numbers
            _dieTexture = D8TextureGenerator.Generate(graphicsDevice, font, dieColor, numberColor);
            ...
            // Generate D8 mesh with UV coordinates
            _mesh = D8Generator.Generate(graphicsDevice, 1.5f);
        ...
        public void Roll()
        {
            ...
            CurrentResult = _random.Next(1, 9);
        ...
        /// <summary>
        /// Draw the D8 die with textured faces.
        /// </summary>
        ...
        private Vector3 GetRotationForResult(int result)
        {
            ...
            for (int i = 0; i < 8; i++)
            {
                if (D8Generator.FaceNumbers[i] == result)
                {
                    targetFace = i;
                    break;
                }
