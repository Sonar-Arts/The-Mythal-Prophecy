...
{
    /// <summary>
    /// Renders a D12 die with textured number faces.
    /// Click to roll the die with animation.
    /// </summary>
    public class D12TestRenderer : IDisposable
    {
        private readonly GraphicsDevice _graphicsDevice;
        private readonly BasicEffect _effect;
        private readonly Texture2D _dieTexture;
        private D12Generator.D12Mesh _mesh;
        ...
        /// </summary>
        public int CurrentResult { get; private set; } = 12;
        ...
        public D12TestRenderer(GraphicsDevice graphicsDevice, SpriteFont font)
        {
            _graphicsDevice = graphicsDevice ?? throw new ArgumentNullException(nameof(graphicsDevice));
            _previousMouseState = Mouse.GetState();

            // Generate D12 texture atlas
            Color dieColor = new Color(180, 20, 30);    // Classic red
            Color numberColor = new Color(255, 215, 0); // Gold numbers
            _dieTexture = D12TextureGenerator.Generate(graphicsDevice, font, dieColor, numberColor);
            ...
            // Generate D12 mesh with UV coordinates
            _mesh = D12Generator.Generate(graphicsDevice, 1.5f);
        ...
        public void Roll()
        {
            ...
            CurrentResult = _random.Next(1, 13);
        ...
        /// <summary>
        /// Draw the D12 die with textured faces.
        /// </summary>
        ...
        private Vector3 GetRotationForResult(int result)
        {
            ...
            for (int i = 0; i < 12; i++)
            {
                if (D12Generator.FaceNumbers[i] == result)
                {
                    targetFace = i;
                    break;
                }
