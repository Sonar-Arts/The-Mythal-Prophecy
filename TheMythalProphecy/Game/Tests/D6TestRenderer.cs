...
{
    /// <summary>
    /// Renders a D6 die with textured number faces.
    /// Click to roll the die with animation.
    /// </summary>
    public class D6TestRenderer : IDisposable
    {
        private readonly GraphicsDevice _graphicsDevice;
        private readonly BasicEffect _effect;
        private readonly Texture2D _dieTexture;
        private D6Generator.D6Mesh _mesh;
        ...
        /// </summary>
        public int CurrentResult { get; private set; } = 6;
        ...
        public D6TestRenderer(GraphicsDevice graphicsDevice, SpriteFont font)
        {
            _graphicsDevice = graphicsDevice ?? throw new ArgumentNullException(nameof(graphicsDevice));
            _previousMouseState = Mouse.GetState();

            // Generate D6 texture atlas
            Color dieColor = new Color(30, 140, 60);    // Green
            Color numberColor = new Color(255, 215, 0); // Gold numbers
            _dieTexture = D6TextureGenerator.Generate(graphicsDevice, font, dieColor, numberColor);
            ...
            // Generate D6 mesh with UV coordinates
            _mesh = D6Generator.Generate(graphicsDevice, 1.5f);
        ...
        /// <summary>
        /// Draw the D6 die with textured faces.
        /// </summary>
        ...
        private Vector3 GetRotationForResult(int result)
        {
            ...
            for (int i = 0; i < 6; i++)
            {
                if (D6Generator.FaceNumbers[i] == result)
                {
                    targetFace = i;
                    break;
                }
