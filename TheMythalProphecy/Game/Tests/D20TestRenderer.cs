...
{
    /// <summary>
    /// Renders a D20 die with textured number faces.
    /// Click to roll the die with animation.
    /// </summary>
    public class D20TestRenderer : IDisposable
    {
        private readonly GraphicsDevice _graphicsDevice;
        private readonly BasicEffect _effect;
        private readonly Texture2D _dieTexture;
        private D20Generator.D20Mesh _mesh;
        ...
        /// </summary>
        public int CurrentResult { get; private set; } = 20;
        ...
        public D20TestRenderer(GraphicsDevice graphicsDevice, SpriteFont font)
        {
            _graphicsDevice = graphicsDevice ?? throw new ArgumentNullException(nameof(graphicsDevice));
            _previousMouseState = Mouse.GetState();

            // Generate D20 texture atlas
            Color dieColor = new Color(180, 20, 30);    // Classic red
            Color numberColor = new Color(255, 215, 0); // Gold numbers
            _dieTexture = D20TextureGenerator.Generate(graphicsDevice, font, dieColor, numberColor);
            ...
            // Generate D20 mesh with UV coordinates
            _mesh = D20Generator.Generate(graphicsDevice, 1.5f);
        ...
        public void Roll()
        {
            ...
            CurrentResult = _random.Next(1, 21);
        ...
        /// <summary>
        /// Draw the D20 die with textured faces.
        /// </summary>
        ...
        private Vector3 GetRotationForResult(int result)
        {
            ...
            for (int i = 0; i < 20; i++)
            {
                if (D20Generator.FaceNumbers[i] == result)
                {
                    targetFace = i;
                    break;
                }
