...
{
    /// <summary>
    /// Renders a D4 die with textured number faces.
    /// Click to roll the die with animation.
    /// </summary>
    public class D4TestRenderer : IDisposable
    {
        private readonly GraphicsDevice _graphicsDevice;
        private readonly BasicEffect _effect;
        private readonly Texture2D _dieTexture;
        private D4Generator.D4Mesh _mesh;
        ...
        /// </summary>
        public int CurrentResult { get; private set; } = 4;
        ...
        public D4TestRenderer(GraphicsDevice graphicsDevice, SpriteFont font)
        {
            _graphicsDevice = graphicsDevice ?? throw new ArgumentNullException(nameof(graphicsDevice));
            _previousMouseState = Mouse.GetState();

            // Generate D4 texture atlas
            Color dieColor = new Color(200, 170, 30);   // Yellow/Gold
            Color numberColor = Color.Black;            // Black numbers
            _dieTexture = D4TextureGenerator.Generate(graphicsDevice, font, dieColor, numberColor);
            ...
            // Generate D4 mesh with UV coordinates
            _mesh = D4Generator.Generate(graphicsDevice, 1.5f);
        ...
        public void Roll()
        {
            ...
            CurrentResult = _random.Next(1, 5);
        ...
        /// <summary>
        /// Draw the D4 die with textured faces.
        /// </summary>
        ...
        private Vector3 GetRotationForResult(int result)
        {
            ...
            for (int i = 0; i < 4; i++)
            {
                if (D4Generator.FaceNumbers[i] == result)
                {
                    targetFace = i;
                    break;
                }
