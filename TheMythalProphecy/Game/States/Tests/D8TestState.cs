...
{
    /// <summary>
    /// Test state for rendering a 3D D8 die with roll animation.
    /// Click to roll the die, drag to orbit camera.
    /// </summary>
    public class D8TestState : IGameState
    {
        private readonly ContentManager _content;
        private readonly GameStateManager _stateManager;

        private D8TestRenderer _testRenderer;
        private SpriteFont _font;
        private KeyboardState _previousKeyState;

        public D8TestState(ContentManager content, GameStateManager stateManager)
        {
            _content = content;
        ...
        public void Enter()
        {
            ...
            _testRenderer = new D8TestRenderer(GameServices.GraphicsDevice, _font);
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            Color resultColor = _testRenderer.IsRolling ? Color.White :
                (_testRenderer.CurrentResult == 8 ? new Color(0, 255, 100) :  // Max = green
