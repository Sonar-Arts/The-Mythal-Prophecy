...
{
    /// <summary>
    /// Test state for rendering a 3D D6 die with roll animation.
    /// Click to roll the die, drag to orbit camera.
    /// </summary>
    public class D6TestState : IGameState
    {
        private readonly ContentManager _content;
        private readonly GameStateManager _stateManager;

        private D6TestRenderer _testRenderer;
        private SpriteFont _font;
        private KeyboardState _previousKeyState;

        public D6TestState(ContentManager content, GameStateManager stateManager)
        {
            _content = content;
        ...
        public void Enter()
        {
            ...
            _testRenderer = new D6TestRenderer(GameServices.GraphicsDevice, _font);
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            Color resultColor = _testRenderer.IsRolling ? Color.White :
                (_testRenderer.CurrentResult == 6 ? new Color(0, 255, 100) :  // Max = green
