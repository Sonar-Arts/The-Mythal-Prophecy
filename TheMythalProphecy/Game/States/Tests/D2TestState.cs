...
{
    /// <summary>
    /// Test state for rendering a 3D coin (D2) with flip animation.
    /// Click to flip the coin, drag to orbit camera.
    /// </summary>
    public class D2TestState : IGameState
    {
        private readonly ContentManager _content;
        private readonly GameStateManager _stateManager;

        private D2TestRenderer _testRenderer;
        private SpriteFont _font;
        private KeyboardState _previousKeyState;

        public D2TestState(ContentManager content, GameStateManager stateManager)
        {
            _content = content;
        ...
        public void Enter()
        {
            ...
            _testRenderer = new D2TestRenderer(GameServices.GraphicsDevice, _font);
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            // Title
            string title = "COIN FLIP TEST (D2)";
            ...
            // Flip result display
            string resultText = _testRenderer.IsRolling ? "Flipping..." : $"Result: {_testRenderer.CurrentResult}";
            Color resultColor = _testRenderer.IsRolling ? Color.White :
                (_testRenderer.CurrentResult == 1 ? new Color(100, 200, 255) :  // 1 = light blue
                 new Color(255, 180, 100));                                       // 2 = orange
