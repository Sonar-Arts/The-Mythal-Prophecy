...
{
    /// <summary>
    /// Test state for rendering a 3D D20 die with roll animation.
    /// Click to roll the die, drag to orbit camera.
    /// </summary>
    public class D20TestState : IGameState
    {
        private readonly ContentManager _content;
        private readonly GameStateManager _stateManager;

        private D20TestRenderer _testRenderer;
        private SpriteFont _font;
        private KeyboardState _previousKeyState;

        public D20TestState(ContentManager content, GameStateManager stateManager)
        {
            _content = content;
        ...
        public void Enter()
        {
            ...
            _testRenderer = new D20TestRenderer(GameServices.GraphicsDevice, _font);
        ...
        public void Draw(SpriteBatch spriteBatch, GameTime gameTime)
        {
            ...
            Color resultColor = _testRenderer.IsRolling ? Color.White :
                (_testRenderer.CurrentResult == 20 ? new Color(0, 255, 100) :  // Nat 20 = green
                 _testRenderer.CurrentResult == 1 ? new Color(255, 80, 80) :   // Nat 1 = red
                 Color.White);
