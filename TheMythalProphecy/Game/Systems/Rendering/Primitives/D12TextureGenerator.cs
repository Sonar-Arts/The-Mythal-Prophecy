...
{
    /// <summary>
    /// Generates a texture atlas for D12 die faces with numbers 1-12.
    /// Layout is a 4x3 grid where each cell contains one number.
    /// </summary>
    public static class D12TextureGenerator
    {
        ...
        /// <summary>
        /// Generates the D12 texture atlas with numbers 1-12.
        /// </summary>
        ...
        private static void DrawCenteredNumber(SpriteBatch spriteBatch, SpriteFont font, int number, int cellX, int cellY, int cellSize, Color color)
        {
            ...
            Vector2 maxSize = font.MeasureString("12");
        ...
        /// <summary>
        /// Gets UV coordinates for a pentagonal face, properly oriented based on face geometry.
        /// </summary>
        /// <param name="faceNumber">The number (1-12) to display on this face</param>
        /// <param name="vertices">The 5 vertices of the pentagon</param>
        /// <param name="faceCenter">The center of the face</param>
        /// <param name="faceNormal">The face normal (pointing outward)</param>
        /// <returns>UV coordinates for the 5 vertices plus the center (index 5)</returns>
            ...
            Vector3 faceNormal)
        {
            ...
            // Center UV
            uvs[5] = new Vector2(cellCenterU, 1f - cellCenterV);
