...
{
    /// <summary>
    /// Generates a texture atlas for D8 die faces with numbers 1-8.
    /// Layout is a 4x2 grid where each cell contains one number.
    /// </summary>
    public static class D8TextureGenerator
    {
        ...
        /// <summary>
        /// Generates the D8 texture atlas with numbers 1-8.
        /// </summary>
        ...
        private static void DrawCenteredNumber(SpriteBatch spriteBatch, SpriteFont font, int number, int cellX, int cellY, int cellSize, Color color)
        {
            ...
            Vector2 maxSize = font.MeasureString("8");
        ...
        /// </summary>
        /// <param name="faceNumber">The number (1-8) to display on this face</param>
