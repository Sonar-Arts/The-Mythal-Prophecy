...
{
    /// <summary>
    /// Generates a texture atlas for D10 die faces with numbers 0-9.
    /// Layout is a 5x2 grid where each cell contains one number.
    /// </summary>
    public static class D10TextureGenerator
    {
        ...
        /// <summary>
        /// Generates the D10 texture atlas with numbers 0-9.
        /// </summary>
        ...
        private static void DrawCenteredNumber(SpriteBatch spriteBatch, SpriteFont font, int number, int cellX, int cellY, int cellSize, Color color)
        {
            ...
            Vector2 maxSize = font.MeasureString("0");
        ...
        /// <summary>
        /// Gets UV coordinates for a kite-shaped face, properly oriented based on face geometry.
        /// </summary>
        /// <param name="faceNumber">The number (0-9) to display on this face</param>
        /// <param name="vertices">The 4 vertices of the kite</param>
        ...
        public static Vector2[] GetFaceUVs(
            ...
            Vector3 faceNormal)
        {
            if (faceNumber < 0 || faceNumber > 9)
                faceNumber = 0;

            // Get the texture cell bounds for this number
            int index = faceNumber;
            ...
            // Determine "up" direction on the face (toward first vertex - the pole)
