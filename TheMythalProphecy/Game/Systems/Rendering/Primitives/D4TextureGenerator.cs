...
{
    /// <summary>
    /// Generates a texture atlas for D4 die faces with numbers 1-4.
    /// Layout is a 2x2 grid where each cell contains one number.
    /// </summary>
    public static class D4TextureGenerator
    {
        ...
        /// <summary>
        /// Generates the D4 texture atlas with numbers 1-4.
        /// </summary>
        ...
        private static void DrawCenteredNumber(SpriteBatch spriteBatch, SpriteFont font, int number, int cellX, int cellY, int cellSize, Color color)
        {
            ...
            Vector2 maxSize = font.MeasureString("4");
        ...
        /// <summary>
        /// Gets UV coordinates for a triangular face, properly oriented based on face geometry.
        /// </summary>
        /// <param name="faceNumber">The number (1-4) to display on this face</param>
        /// <param name="vertices">The 3 vertices of the triangle</param>
        /// <param name="faceCenter">The center of the face</param>
        /// <param name="faceNormal">The face normal (pointing outward)</param>
        /// <returns>UV coordinates for the 3 vertices</returns>
